                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td>{$status}</td>
                            <td>
                                <a href='booking-list.php?action=confirm&id={$row['id']}' class='btn btn-success btn-sm' onclick='return confirm(\"Are you sure you want to confirm this booking?\")'>Confirm</a>
                                ...
                                <a href='booking-list.php?action=delete&id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this booking?\")'>Delete</a>
                            </td>
                        </tr>";
                    }
                } else {
